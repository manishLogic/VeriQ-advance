...
export default function RegisterPage() {
    ...
    return (
        <main className="min-h-screen flex items-center justify-center bg-[#070d14] p-6 relative overflow-hidden pt-20 pb-20">
            ...
            <div className="w-full max-w-[480px] relative z-10">
                ...
                <div className="bg-[#0d1722] rounded-3xl p-8 md:p-10 border border-white/5 shadow-[0_0_50px_rgba(0,0,0,0.5)] relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-64 h-64 bg-[#00d4d4]/5 blur-[80px] rounded-full pointer-events-none" />

                    <div className="relative z-10">
                        <RoleToggle role={role} onChange={setRole} />
                        <RegisterForm role={role} key={`reg-${role}`} />
                    </div>
                </div>
            </div>
        </main>
