...
export default function CandidateReports() {
    ...
    // ONLY show candidates who have attempted the test
        ...
        <div className="p-8 md:p-12 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
            <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-2">
                    <h1 className="text-3xl font-sora font-bold text-white">Candidate Reports</h1>
                    <p className="text-[#8a9ab0]">Test results and trust scores for candidates who have completed technical screening.</p>
                </div>
            ...
            <div className="relative">
                ...
                <input
                    ...
                    placeholder="Search tested candidates..."
            ...
            <div className="grid grid-cols-1 w-full md:grid-cols-2 xl:grid-cols-3 gap-6">
                {isLoading ? (
                    ...
                    filteredCandidates.map((candidate) => {
                        ...
                        if (candidate.score !== null && candidate.score < 60) {
                            scoreColor = "text-red-400 bg-red-400/10 border-red-400/20";
                            badgeColor = "bg-red-500";
                        } else if (candidate.score !== null && candidate.score < 80) {
            ...
            {!isLoading && filteredCandidates.length === 0 && (
                <div className="text-center py-20 bg-[#0d1722] rounded-2xl border border-white/5">
                    <p className="text-[#8a9ab0]">No test reports found matching your criteria.</p>
                </div>
            )}
        </div>
    );
